...
[Go-clean-template](https://minhhoccode111.com/go-clean-template-gin?utm_source=github&utm_campaign=go-clean-template-gin) создан и
поддерживается [minhhoccode111](https://minhhoccode111.com/?utm_source=github&utm_campaign=go-clean-template-gin).
...
## Очистка шаблона (Только Gin REST API)

Если вам нужен только простой REST API, и вы хотите удалить gRPC, NATS и RabbitMQ из проекта, вы можете запустить предоставленный скрипт очистки:

```sh
./remove_rpc.sh
```

Это автоматически удалит весь связанный с RPC код, зависимости, конфигурации docker и тесты, оставив вам чистый шаблон Gin REST API.
